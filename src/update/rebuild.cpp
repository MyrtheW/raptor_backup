...
//// METHOD 2
//
//void recall_dp_1(size_t ibf_idx,
...
//}
    //////////////
    // chopper full
    // --num-hash-functions 2 --false-positive-rate 0.05 --input-file all_bin_paths.txt --output-filename hibf_12_12_ebs.layout --rearrange-user-bins --kmer-size 20 --tmax 64 --update-UBs 0.10
    //count --input-file /mnt/c/Users/myrth/Desktop/coding/raptor/build/bin/all_bin_paths.txt --output-prefix input_data --kmer-size 20
    //layout --tmax 192 --num-hash-functions 2 --false-positive-rate 0.05 --input-prefix input_data --output-filename hibf_empty_ubs.layout --rearrange-user-bins --update-UBs 0.10
    ...
    config.rearrange_user_bins = false; //update.similarity
    config.false_positive_rate = 0.05;
    //chopper::layout::execute(config); //make sure to use empty bins.
    int exit_code{};
    try
    {
...
//void get_kmer_counts(raptor_index<index_structure::hibf> & index, update_arguments const & arguments, count_filename){
